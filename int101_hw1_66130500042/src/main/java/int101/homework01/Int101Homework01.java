...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       ...
       System.out.println("Your MBI is : "+ work03.MyUtil.calculateBMI(47, 1.58));
       System.out.println("Average is : "+ work03.MyUtil.average(1, 9, 7));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      BankAccount BankAccount1 = new BankAccount(1,P);
      Person T = new Person(2);
      BankAccount BankAccount2 = new BankAccount(2,T);
      BankAccount1.deposit(100);
      BankAccount2.deposit(200);
      BankAccount1.withdraw(50);
      BankAccount2.withdraw(100);
      BankAccount1.transfer(25, BankAccount2);
